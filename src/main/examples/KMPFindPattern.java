...
public class KMPFindPattern {
	 ...
	 *            the pattern string
	 */
	public KMPFindPattern(String pat) {
		this.R = 256;
		this.pat = pat;
	 ...
	 *            the alphabet size
	 */
	public KMPFindPattern(char[] pattern, int R) {
		this.R = R;
	...
	public static void main(String[] args) {
		...
		KMPFindPattern kmp1 = new KMPFindPattern(pat);
		int offset1 = kmp1.search(txt);

		KMPFindPattern kmp2 = new KMPFindPattern(pattern, 256);
